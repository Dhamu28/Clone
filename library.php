...
<?php 	
 ...
 <head>
 	...
 	<title><?=ucwords($rows['name'])?> Dashboard</title>
...
<aside id="cta-button-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="ms-3"><?=ucwords($rows['name'])?></span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap"><?=$rows['user']?></span>
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Seat Number</span>
               <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"><?=$rows['seat_num']?></span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="/library/logout/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
      ...
      <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900 drop-shadow-2xl" role="alert">
         <div class="flex items-center mb-3">
            <span class="bg-orange-100 text-orange-800 text-sm font-semibold me-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900">Help</span>
         ...
         <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
            For any query regarding library services, Please make a call to Admin on 7230890008
         </p>
         <a class="text-sm text-blue-800 underline font-medium hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" href="tel:7230890008">Make a call</a>
      </div>
   </div>
</aside>
...
<div class="p-4 sm:ml-64">
   ...
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      <div class="grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-2 mb-4">
        ...
        <div class="backdrop-blur-sm bg-black/10 dark:bg-white/10 p-2 rounded-lg">
            <p class="md:text-2xl text-lg text-gray-400 dark:text-gray-200 font-medium">Registeration Date</p>
        </div>
            <p class="md:text-2xl text-lg text-gray-400 dark:text-gray-200 py-2">
               <?=$rows['toj']?>
            </p>
      ...
      <div class="flex items-center gap-8 h-48 mb-4 rounded bg-gradient-to-r from-purple-500 to-pink-500 drop-shadow-2xl">
         <div class="bg-white rounded-full md:size-44 size-28 md:ms-8 ms-3 flex items-center justify-center drop-shadow-2xl">
         	<img src="/library/images/male.svg" class="md:h-40 h-20" alt="User Avtar">
         </div>
         <p class="md:text-5xl text-2xl tracking-wider font-medium text-gray-400 dark:text-white">
            <?=ucwords($rows['name'])?>
         </p>
      </div>
